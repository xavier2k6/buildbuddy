...
type UserInfo interface {
	...
	// Constructs a JWT out of this UserInfo.
...
type GRPCAuthenticator interface {
	...
	// present in the gRPC metadata and returns the result.
	//
	...
	// TODO(iain): egregious hack but just checking something...
	PermitUnauthenticatedStuff() bool
}
